...
class OrderControllerTest {
    ...
    @Test
    void testDeleteOrderById_WhenOrderIsPending_ShouldReturn200Ok() throws Exception {
    ...
    @Test
    void testDeleteOrderById_WhenOrderIsNotPending_ShouldReturn400BadRequest() throws Exception {
